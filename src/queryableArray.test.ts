...
describe("query array", () => {
  ...
  describe("native array methods", () => {
    ...
    describe("reduce", () => {
      it("returns the same result as Array.reduce when not an array", () => {
        const qa = new QueryableArray(data);
      ...
      it("wraps the result in a queryable array when reduce returns an array", () => {
        const qa = new QueryableArray(data);
        expect(
          qa.reduce((acc, t) => [...acc, t], [] as any[]),
        ).to.be.instanceOf(QueryableArray);
      });
    });
    ...
    describe("reduceRight", () => {
      ...
      it("wraps the result in a queryable array when reduceRight returns an array", () => {
        const qa = new QueryableArray(data);
        expect(
          qa.reduceRight((acc, t) => [...acc, t], [] as any[]),
        ).to.be.instanceOf(QueryableArray);
      });
    });
